              ...
              <table class="table table-striped table-bordered">
                ...
                <tbody>';
                        while ($row = mysqli_fetch_array($query)) {
                            ...
                            <td>' . $row['6'] . '</td>
                        <td align="center">
                          <a href="#" data-bs-toggle="modal" data-bs-target="#editpbo' . $row["3"] . '"><i class="text-dark" data-feather="edit"></i></a>
                        </td>
                      </tr>'; ?>

                            <!-- Modal Edit PBO -->
                            <div class="modal fade" id="editpbo<?= $row[3] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
